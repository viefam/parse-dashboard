  ...
  render() {
    ...
    const JobsRoute = props => (
      <Switch>
        ...
        />
        <Route
          path={props.match.path + "/edit/:jobId"}
          render={props => (
            <JobsData {...props} params={props.match.params}>
              <JobEdit params={props.match.params} />
            </JobsData>
    ...
    const AnalyticsRoute = ({ match }) => (
      <Switch>
        ...
        <Redirect
          exact
          from={match.path + "/explorer"}
          to="/apps/:appId/analytics/explorer/chart"
        />
        <Route
          path={match.path + "/explorer/:displayType"}
          component={Explorer}
        />
    ...
    const ApiConsoleRoute = props => (
      <Switch>
        ...
        />
        <Route
          path={props.match.path + "/js_console"}
          render={props => (
            <ApiConsole {...props}>
              <Playground />
            </ApiConsole>
    ...
    const AppRoute = ({ match }) => (
      <AppData params={match.params}>
        <Switch>
          ...
          <Route
            path={match.path + "/browser/:className/:entityId/:relationName"}
            component={BrowserRoute}
          />
          <Route
            path={match.path + "/browser/:className"}
            component={BrowserRoute}
          />
          ...
          <Route
            path={match.path + "/logs/:type"}
            render={props => <Logs {...props} params={props.match.params} />}
          />
          <Redirect from={match.path + "/logs"} to="/apps/:appId/logs/info" />

          <Route path={match.path + "/config"} component={Config} />
          <Route
            path={match.path + "/api_console"}
            component={ApiConsoleRoute}
          />
          <Route path={match.path + "/stats"} component={StatsRoute} />
          <Route path={match.path + "/migration"} component={Migration} />

          <Redirect
            exact
            from={match.path + "/push"}
            to="/apps/:appId/push/new"
          />
          <Redirect
            exact
            from={match.path + "/push/activity"}
            to="/apps/:appId/push/activity/all"
          />

          <Route
            path={match.path + "/push/activity/:category"}
            render={props => (
              <PushIndex {...props} params={props.match.params} />
            )}
          />
          <Route
            path={match.path + "/push/audiences"}
            component={PushAudiencesIndex}
          />
          <Route path={match.path + "/push/new"} component={PushNew} />
          <Route
            path={match.path + "/push/:pushId"}
            render={props => (
          ...
          <Redirect
            exact
            from={match.path + "/analytics"}
            to="/apps/:appId/analytics/overview"
          />
          <Route path={match.path + "/analytics"} component={AnalyticsRoute} />
          <Redirect
            exact
            from={match.path + "/settings"}
